...
class Task(Base):
    ...
    role_links = relationship("RoleTaskLink", back_populates="task", lazy="selectin")
    procedure_links = relationship("TaskProcedureLink", back_populates="task", lazy="selectin")
